...
describe( "amd-inject-loader", function() {
	...
	it( "should tranform the file correctly even when define has one argument per line", function() {
		var factory = er( "../index.js!./examples/argPerLine" );
		var resp = factory.toString();
